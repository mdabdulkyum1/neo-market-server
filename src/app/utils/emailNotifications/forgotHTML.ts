...
<head>
    ...
    <title>Neo Market - Password Reset</title>
    <style>
                ...
                <div class="email-container">
                    ...
                    <div class="email-header">
                        <div class="company-logo">
                            ...
                            <div class="company-name">Neo Market</div>
                            <div class="company-tagline">Digital Marketplace</div>
                        </div>
                    </div>
                    ...
                    <div class="email-content">
                        ...
                        <p class="main-text">
                            We received a request to reset the password for your account on <span
                                class="brand-highlight">Neo Market</span>. Use this OTP to complete the password reset
                            process.
                        </p>

                        <p class="warning-text">
                            Remember, Never share this OTP with anyone, not even if <span
                                class="brand-highlight">Neo Market</span> asks you.
                        </p>
                    ...
                    <div class="social-section">
                        ...
                        <div class="email-signature">
                            ...
                            <p class="team-name">Team <span class="brand-highlight">Neo Market</span>.</p>
                        </div>
                    </div>
                </div>
            </td>
